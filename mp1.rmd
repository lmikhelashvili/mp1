...
We also examine the racial distribution of people killed by the police as it relates to geography. In almost every state and region of the US, we see that the number of white people killed by the police exceeds the number of people of color killed by the police. However, this data should not be taken out of context: we should expect that a higher number of white people are killed by the police because white people make up the majority of the US population. White people of non-Hispanic origin [account for around 60% of the population](https://www.census.gov/quickfacts/fact/table/US/PST045219), whereas Black people, the next most frequently killed demographic, account for only 13.4% of the population. Although we see higher numbers of white people being killed, when racial demographics are take into account, the number of people of color killed by the police is disproportionately high ^[Feldman, J., Gruskin, S., Coull, B., & Krieger, N. (2019). Police-Related Deaths and Neighborhood Economic and Racial/Ethnic Polarization, United States, 2015–2016. American Journal Of Public Health, 109(3), 458-464. https://doi.org/10.2105/ajph.2018.304851].
